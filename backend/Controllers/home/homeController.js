...
class homeController {
    ...
    //             const updateDetails = await homeModel.findByIdAndUpdate(id,{
    //                 celebName:name[0],
    //                 celebImage:imageResult.secure_url,
    //                 celebImagePublicId:imageResult.public_id,
    //                 celebVideo:videoResult.secure_url,
    ...
    //            if(updateDetails){
    //                  await cloudinary.uploader.destroy(previousDetails.celebImagePublicId)
    //                  await cloudinary.uploader.destroy(previousDetails.celebVideoPublicId)
    //                  responseReturn(res, 201, { 
    //                     updateDetails, 
