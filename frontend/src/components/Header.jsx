                    ...
                    <div className='flex items-center justify-between gap-x-4'>
                        ...
                        `}>
                            <div className='flex flex-col md:flex-row items-center gap-4 md:gap-6'>
                                ...
                                <button  onClick={()=>{setIsReady(true);setIsSubmited(true);setCheckStatus(!CheckStatus);setIsSubmited(true);setMyloader(false)}} className='w-full md:w-auto bg-accent-100 text-lg font-semibold capitalize px-6 py-2 rounded-md hover:bg-accent-200 transition-colors duration-200'>
